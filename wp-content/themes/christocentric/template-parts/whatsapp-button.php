...
<a
    ...
    aria-label="<?php esc_attr_e('Chat with the shop on WhatsApp', 'christocentric'); ?>"
>
    <span class="ccr-whatsapp-fab-icon" aria-hidden="true">
    ...
    <span class="screen-reader-text"><?php esc_html_e('Chat with the shop on WhatsApp', 'christocentric'); ?></span>
</a>
